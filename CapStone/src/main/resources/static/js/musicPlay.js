	    ...
	    allMusic.forEach(function (music) {
			...
			document.addEventListener('click', function (event) {
			    if (event.target.classList.contains('music-list-play-button')) {
					...
					localStorage.setItem('musicIndex', clickedRowIndex);
					localStorage.setItem('musicInfo', JSON.stringify({
						id: clickedMusic.id,
				        musicUrl: clickedMusic.musicUrl,
				        imgUrl: clickedMusic.imgUrl,
				        aiSinger: clickedMusic.aiSinger,
				        title: clickedMusic.title,
				        oriSinger: clickedMusic.oriSinger,
				        nickname: clickedMusic.nickname
				    }));
